...
const retrieveFundraisers = async () => {
    ...
    return result.map((r) => {
        return {
            ...r,
            amountNeeded: ethers.formatEther(r.amountNeeded),
            amountCollected: ethers.formatEther(r.amountCollected),
        };
    });
};
